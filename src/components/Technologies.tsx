            ...
            return (
              <button
                ...
                className={`glass absolute group cursor-pointer
                  ...
                  ${isExpanded 
                    ...
                    : 'rounded-full w-32 h-32 hover-glow'}`}
                style={{ 
                  top: position.top,
                  left: position.left,
              ...
              >
                <div className={`flex items-center justify-center transition-all duration-500
                  ${isExpanded ? 'flex-col items-start' : 'h-full'}`}>
                  <span className={`text-base font-light transition-all duration-300 text-center
                    ${isExpanded ? 'text-xl text-primary mb-3' : 'text-foreground/90 group-hover:text-primary'}`}>
                    {tech.name}
                  </span>
                  <div 
